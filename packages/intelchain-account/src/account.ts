...
import { Transaction, RLPSign } from '@intelchain-js/transaction';
import { StakingTransaction } from '@intelchain-js/staking';
import { Messenger, RPCMethod } from '@intelchain-js/network';
...
class Account {
   ...
   * const { Account } = require('@intelchain-js/account');
   *
  ...
  async signTransaction(
    ...
    if (updateNonce) {
      ...
      transaction.setParams({
        ...
        from:
          this.messenger.chainPrefix === ChainType.Intelchain
            ? this.bech32Address
   ...
   *
   * > itc103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7-0
   * ```
   */
