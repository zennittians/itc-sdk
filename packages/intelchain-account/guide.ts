...
Creating new account and display hex and bech32 (Itc) addresses 
```javascript
...
*   ),
* );
* const { TransactionFactory } = require('@intelchain-js/transaction');
* const { Unit } = require('@intelchain-js/utils');
...
```javascript
* const passphrase = 'intelchain-itc';
