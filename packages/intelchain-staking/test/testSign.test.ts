...
import { getAddressFromPrivateKey } from '@intelchain-js/crypto';
import { HttpProvider, Messenger } from '@intelchain-js/network';
import { ChainID, ChainType, isValidAddress } from '@intelchain-js/utils';
...
const msgHttp = new Messenger(http, ChainType.Intelchain, ChainID.ItcLocal);
// const msgWs = new Messenger(ws, ChainType.Intelchain, ChainID.ItcLocal);
