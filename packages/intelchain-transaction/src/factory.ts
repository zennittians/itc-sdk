...
import { getContractAddress, getAddress } from '@intelchain-js/crypto';
...
export class TransactionFactory {
   ...
   * @example
   * ```javascript
   * const cloneTxn = itc.transactions.clone(txn);
   ...
   *
   * const recoverTx = itc.transactions.recover(txHash);
