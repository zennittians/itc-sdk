...
*   encryptPhrase,
*   decryptPhrase
* } = require('@intelchain-js/crypto');
* const { isPrivateKey, isAddress, isPublicKey } = require('@intelchain-js/utils');
```

Address apis
```javascript
const bytes = randomBytes(20);
const addr = new IntelchainAddress(bytes);

console.log(addr.checksum);
console.log(addr.bech32);

console.log(IntelchainAddress.isValidBech32(addr.bech32));
```
